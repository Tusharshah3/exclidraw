...
function App() {
  return (
    <div className="min-h-screen bg-gradient-to-br from-red-800 via-green-400  to-purple-600 text-white">
      {/* {<herosection />} */
      <NavBar />
      }
      {/* {<AuthPage} */}
        ...
        <div className="container mx-auto px-4 py-16 sm:px-6 lg:px-8">
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight sm:text-6xl text-foreground">
              ...
              <span className="text-white text-primary block">Made Simple</span>
            </h1>
